 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,es: 'Su dispositivo no ha sido autorizado todavía'
    ...
    ,'Carbs-on-Board' : {
      ...
      ,es: 'COB-Hidratos de Carbono Activos'
    ...
    ,'Bolus Wizard Preview' : {
      ...
      ,es: 'Vista previa del bolo sugerido'
    ...
    ,'Drag&drop food here' : {
      ...
      ,es: 'Arrastrar y soltar comida aquí'
